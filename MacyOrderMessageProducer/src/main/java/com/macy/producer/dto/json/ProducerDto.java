package com.macy.producer.dto.json;
...
public class ProducerDto implements Serializable {
    ...
    public ProducerDto(String messageName, String imagePathname, double itemHeight, String upcList, double itemLength, String command, String itemName, String pickType, double itemWidth, String rfidTagged, String itemDescription, int storageAttribute, double itemWeight) {
